...
# object):
fobj  = open(SRCFILE, mode='r') #you want to use the reading mode with 'f' MY COMMENT
...
# Close the file --> If you dont close it it will not save it MY COMMENT
fobj.close()
print(fobj.closed)
...
# Contents using `.read`
cnts = fobj.read() #CAN PUT # OVER THIS ONE AND TAKE IT AWAY FOR THE ONE UNDER, THIS WILL CHANGE THE OUTCOME
#cnts = ''
...
# To avoid the space between use rstrip:
for i in ['1111\n'.rstrip(), '2222']:
    print(i)
