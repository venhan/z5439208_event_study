...
# C:\Users\vende\PycharmProjects\toolkit\data\test.csv --> the path for data dictonary wrong back slash

#pht = 'C:\\Users\\vende\\PycharmProjects\\toolkit\\data\\test.csv' #--> need to provide one more backslash
#print(pht)
#pht = r'C:\Users\vende\PycharmProjects\toolkit\data\test.csv' #or r in front of the string, its like the f in print
#print(pht)